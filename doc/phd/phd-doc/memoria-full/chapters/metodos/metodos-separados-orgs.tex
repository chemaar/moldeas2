...
\hline
  ...
  \texttt{org:siteAddress} & Recurso \texttt{vcard} que específica los datos de una localización física de una organización o persona & \texttt{org:siteAddress} \url{<http://purl.org/weso/eprocurement/organization/resource/{id}/vcard>}   \\ \hline
  ...
  \texttt{eproc:refCountry} & Enlace a un país & \texttt{eproc:refCountry} \url{<http://purl.org/weso/eprocurement/country/resource/ES>}  \\ \hline 
  \texttt{eproc:refDbpedia} & Enlace al recurso de un país en la DBPedia &  \texttt{eproc:refDbpedia} \url{<http://dbpedia.org/resource/ISO_3166-1:ES>} \\ \hline
  \texttt{eproc:refNuts} & Enlace al recurso de una región en NUTS & \texttt{eproc:refNuts} \url{<http://nuts.psi.enakting.org/id/ES>}  \\ \hline  
  \texttt{eproc:shortLabel} & Código \gls{ISO} 3166 de un país &  \texttt{eproc:shortLabel} ``ES'' \\ \hline
