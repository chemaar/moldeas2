...
A lo largo de este capítulo se utilizará un ejemplo real (no se incluyen todos los datos por su extensión) de generación de datos enlazados 
...
En cuanto a las reglas de negocio o conocimiento que se encuentran en un modelo o especificación 
...
% 
\begin{longtable}[c]{|p{4.5cm}|p{4.5cm}|p{5cm}|} 
\hline
...
\endhead
\url{http://purl.org/weso/ppn/} & URI base para los anuncios de licitación: <base\_uri> & NA \\ \hline
\url{http://purl.org/weso/pc/} & URI base para los contratos públicos: <base\_uri\_pc> & NA \\ \hline
\url{<base_uri_pc>/ontology} & Definiciones comunes a todos los contratos públicos & \url{<base_uri_pc>/ontology/PublicContract} \\ \hline
\url{<base_uri_pc>/resource/ds} & Descripción del catálogo de contratos públicos & \url{<base_uri_pc>/resource/ds} \\ \hline
\url{<base_uri_pc>/resource/{id}} & URI para un recurso representando un contrato público & \url{<base_uri_pc>/resource/010357} \\ \hline
\url{<base_uri>/ontology} & Definiciones comunes a todos los anuncios de licitación & \url{<base_uri>/ontology/Item} \\ \hline
\url{<base_uri>/resource/ds} & Descripción del catálogo de los anuncios de licitación & \url{<base_uri>/resource/ds} \\ \hline
\url{<base_uri>/{year}} & Espacio de nombres para una determinada PSC & \url{<base_uri>/ppn/2012} \\ \hline
\url{<base_uri>/resource/{year}/{id}} & URI para un recurso representando un anuncio de licitación & \url{<base_uri>/resource/2012/010357} \\ \hline
\url{<base_uri>/resource/{year}/{id}/publication/{id}} & URI para un recurso representando una publicación de un anuncio de licitación & \url{<base_uri>/resource/2012/010357/publication/1} \\ \hline
\url{<base_uri>/resource/{year}/{id}/lot/{id}} & URI para un recurso representando un lote de un contrato público & \url{<base_uri>/resource/2012/010357/lot/1} \\ \hline
\url{<base_uri>/resource/{year}/{id}/lot/{id}/item/{id}} & URI para un recurso representando un ítem de un lote de un contrato público & \url{<base_uri>/resource/2012/010357/lot/1/item/1} \\ \hline
\url{<base_uri>/resource/{year}/{id}/lot/{id}/budget} & URI para un recurso representando un presupuesto de un lote de un contrato público & \url{<base_uri>/resource/2012/010357/lot/1/budget} \\ \hline
\url{<base_uri>/resource/{year}/{id}/lot/{id}/payment} & URI para un recurso representando los pagos de un lote de un contrato público & \url{<base_uri>/resource/2012/010357/lot/1/item/1/payment} \\ \hline
\hline
